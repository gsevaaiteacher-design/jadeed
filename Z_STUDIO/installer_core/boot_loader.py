...
class ZStudioBootloader:
    def __init__(self):
        ...
        # =========================
        #  FIX (CRITICAL ORDER FIX)
        # =========================
        self.installer_core = os.path.abspath(
            os.path.join(os.path.dirname(__file__), "..")
        )

        self.base_path = os.path.abspath(
            os.path.join(self.installer_core, "..")
        )
    ...
    def setup_logging(self):
        # installer_core is now guaranteed to exist
    ...
    def initialize_system(self):
        ...
        try:
            ...
            for folder in ["embedded_runtime", "model_storage", "license_core"]:
